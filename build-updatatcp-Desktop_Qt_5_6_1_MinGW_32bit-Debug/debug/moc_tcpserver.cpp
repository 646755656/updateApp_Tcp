...
#include "../../updatatcp/api/tcpserver.h"
...
void TcpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (TcpClient::*_t)(const QString & , int , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpClient::sendData)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (TcpClient::*_t)(const QString & , int , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpClient::receiveData)) {
                *result = 1;
                return;
            }
        }
...
void TcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (TcpServer::*_t)(const QString & , int , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpServer::sendData)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (TcpServer::*_t)(const QString & , int , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpServer::receiveData)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (TcpServer::*_t)(const QString & , int );
